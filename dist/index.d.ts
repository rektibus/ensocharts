...
export declare const CandleType: {
	readonly CandleSolid: "candle_solid";
	readonly CandleStroke: "candle_stroke";
	readonly CandleUpStroke: "candle_up_stroke";
	readonly CandleDownStroke: "candle_down_stroke";
	readonly Ohlc: "ohlc";
	readonly Area: "area";
	readonly Line: "line";
	readonly LineMark: "line_mark";
	readonly StepLine: "step_line";
	readonly HeikinAshi: "heikin_ashi";
	readonly CandleHighLow: "candle_high_low";
	readonly CandleHighLowArea: "candle_high_low_area";
};
...
export declare const YAxisType: {
...
export interface Datafeed {
	...
	getHistoryTViewData(symbol: SymbolInfo, period: Period, from: number, to: number): Promise<KLineData[]>;
...
export declare class ChartMain {
}
declare const overlays: OverlayTemplate[];
export type TViewData = KLineData;
