...
const Footer: Component<FooterProps> = (props) => {
  ...
  return (
    <div class="ensocharts-footer-container">
      <div class="ensocharts-footer-container-start"></div>
      <div class="ensocharts-footer-container-clock">
        {time().toLocaleTimeString()}
      </div>
      <Tooltip top_length={-37} text={i18n('Time Zone', props.locale)}>
        <div
          onClick={props.onTimezoneClick}
          class="ensocharts-footer-container-timezone"
        >
          {props.timezone.text}
        </div>
      </Tooltip>
      <Tooltip top_length={-37} text={i18n('Move to a Date', props.locale)}>
        <div
          ...
          class="ensocharts-footer-container-moveto"
        >
