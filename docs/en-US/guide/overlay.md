...
## Custom overlays
To create custom an overlay, then add it globally via [registerOverlay](/api/chart/registerOverlay) and add it to the chart to use it just like a built-in overlay. For more examples, refer to the files under [https://github.com/ensocharts/KLineChart/tree/main/src/extension/overlay](https://github.com/ensocharts/KLineChart/tree/main/src/extension/overlay) .