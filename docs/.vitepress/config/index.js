...
function config () {
  const ensocharts = fs.readFileSync(
    path.join(path.dirname(process.cwd()), 'dist', 'umd', 'ensocharts.min.js'),
    { encoding: 'utf-8' }
  )
  return defineConfig({
    vite: {
    ...
    themeConfig: {
      ...
      socialLinks: [
        ...
        // { icon: 'twitter', link: 'https://twitter.com/ensocharts' }
      ],
      footer: {
        message: 'Released under the <a href="https://github.com/ensocharts/KLineChart/blob/main/LICENSE">Apache License V2</a>.',
